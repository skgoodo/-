  ...
  <div class="aside-l">
    ...
    <el-menu class="el-menu-vertical-demo" background-color="#00152A" active-text-color="#fff"
      ...
      <el-menu-item>
        ...
        <span slot="title"><a href="https://lison16.github.io/iview-admin-doc/#/%E5%BF%AB%E9%80%9F%E5%BC%80%E5%A7%8B"
            target="_blank">{{$t('message.document')}}</a></span>
      </el-menu-item>
      ...
      <el-submenu index="2">
        <template slot="title">
          <i class="el-icon-umpshangchuanshuju"></i>
      ...
      <el-submenu index="3">
        <template slot="title">
          <i class="el-icon-umpzhuzhuangtu"></i>
    ...
    methods: {
      ...
      getBreadcrumb() {
        ...
        for (var i = 0; i < arr.length; i++) {
          {
            arr2.push(arr[i].meta)
          }
        }
        if (arr2[0].title === undefined) {
          arr2.shift()
        }
        this.$store.commit("setBreadcrumb", arr2)
      },
      //标签栏导航
      getpath() {
        var arr = this.$route.matched
...
<style>
  ...
  .el-icon-umpshuji2 {
    color: rgb(179, 185, 191) !important;
  }
